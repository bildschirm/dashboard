 ...
 * @property {ConnectionStatus} state.connectionStatus The status of the connection to Bildschirm.
 ...
 * @property {Object} state.mcState The Bildschirm state object.
 *
 ...
 * @property {Object} mutations.fullUpdateMcState Fully replace the Bildschirm state object in the store.
 * @property {Object} mutations.updateMcState Partially update the Bildschirm state object in the store.
...
export const store = new Vuex.Store({
	state: {
		...
		mcState: window.BILDSCHIRM_INITIAL_STATE,

		componentPropTypes: {},

		theme: window.BILDSCHIRM_THEME || 'purple',
		services: {
			core: {
