<template>
	<div
		class="absolute w-full h-full rounded-full bg-gradient-to-b"
...
export default {
	...
	computed: {
		colors() {
			return this.active
				? { start: '#8B5CF6', mid: '#844BF1', end: '#7C3AED' }
				: { start: '#6D28D9', mid: '#6424C7', end: '#5B21B6' };
		},
		backgroundClasses() {
			return {
