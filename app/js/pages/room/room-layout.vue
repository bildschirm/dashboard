...
.shadow-rgb {
	...
	box-shadow: 0px 0px 10px 2px var(--rgb-color-a),
		inset 0px 4px 50px 25px var(--rgb-color-a);
}

.shadow-pink {
	box-shadow: 0px 0px 10px 2px rgb(255, 0, 96),
		inset 0px 4px 50px 25px rgba(255, 0, 96, 0.3);
}
</style>
<style lang="scss">
.scale-button {
			...
			<div class="dashboard-box w-full relative">
				<div class="w-full flex flex-col justify-start px-8 py-8">
					<button
						...
						@click="
							toggleSwitch(
								'4c11c0d80eb1e6e9a373bc1c9fce779522a753e9361a47cf303d8eb109efff00'
							)
						"
						@contextmenu.prevent="
							selectDevice(
					...
					<bg-svg
						class="select-none pointer-events-none w-full relative h-1/3 "
					/>
					<button
						class="vibe-button"
